...
train_processed.to_csv('/workspace/output/train_processed.csv', index=False)
test_processed.to_csv('/workspace/output/test_processed.csv', index=False)

print(f"Final Data Shape: {all_data.shape}")
print(f"Files saved in /workspace/output/")