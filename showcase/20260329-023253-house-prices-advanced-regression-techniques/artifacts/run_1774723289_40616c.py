...
if mean_rmse < current_best:
    with open(best_score_path, 'w') as f:
        json.dump({"metric": "rmsle", "score": mean_rmse, "model": "LightGBM", "details": "5-fold CV with Optuna tuning"}, f)
    print(f"Updated best score to {mean_rmse}")
else:
    print(f"Current best score {current_best} is better than or equal to {mean_rmse}")